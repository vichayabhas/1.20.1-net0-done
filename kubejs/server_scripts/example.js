...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.centrifuge('gtceu:centrifuge/impure_naquadria_solution_separation2')
        ...
        .itemOutputs('3x kubejs:new_token')
        .duration(544)
        .EUt(1444)
    ...
    event.recipes.gtceu.assembly_line('scanner_test')
        .itemInputs("24x kubejs:used_sulfur_trioxide_token")
    ...
    event.recipes.gtceu.assembly_line('scanner_test2')
        .itemInputs("24x kubejs:used_token")
        .itemInputs("10x gtceu:titanium_ingot")
        .itemInputs('2x gtceu:indium_dust')
        .itemInputs('2x gtceu:phosphorus_dust')
        .itemInputs('4x gtceu:enriched_naquadah_ingot')
    ...
    event.recipes.gtceu
        ...
        .itemOutputs("24x kubejs:power_ingot")
    ...
    event.recipes.gtceu
        ...
        .itemOutputs("192x kubejs:power_ingot")
    ...
    event.recipes.gtceu.generator('test_gen')
        ...
        .itemInputs('kubejs:used_sulfur_trioxide_token')
        .inputFluids(Fluid.of('gtceu:oxygen',500))
        .itemOutputs('kubejs:used_token')
        .duration(100).EUt(-524288)
    ...
    event.recipes.gtceu.large_chemical_reactor('large_chemical_reactor/sulfur_trioxide_add_token')
        .inputFluids("gtceu:sulfur_dioxide 500")
        .inputFluids("gtceu:oxygen 500")
        .itemInputs("3x kubejs:new_sulfur_trioxide_token")
        .outputFluids("gtceu:sulfur_trioxide 500")
        .itemOutputs("3x kubejs:used_sulfur_trioxide_token")
        .EUt(7)
        .duration(100)
    ...
    event.recipes.gtceu.large_chemical_reactor('gtceu:large_chemical_reactor/fluoroantimonic_acid2')
        .inputFluids('gtceu:hydrofluoric_acid 1000')
        .itemInputs('gtceu:antimony_trifluoride_dust')
        .duration(150)
        .EUt(240)
        .outputFluids('gtceu:fluoroantimonic_acid 250')
        .outputFluids('gtceu:hydrogen 500')
    event.recipes.gtceu.large_chemical_reactor('gtceu:chemical_reactor/potassium_hydroxide2')
        .itemInputs("8x gtceu:rock_salt_dust")
        .itemInputs("8x kubejs:new_token")
        .inputFluids("minecraft:water 4000")
        .duration(750)
        .EUt(64)
        .outputFluids("gtceu:hydrochloric_acid 4000")
        .itemOutputs("12x gtceu:potassium_hydroxide_dust")
        .itemOutputs("8x kubejs:new_sulfur_trioxide_token")
    event.recipes.gtceu.large_chemical_reactor('gtceu:chemical_reactor/potassium_hydroxide_circuit')
